...
const ItemDetails = () => {
    ...
    useEffect(() => {
        const fetchDetails = async () => {
          try {
            const { data } = await axios.get(`https://us-central1-nft-cloud-functions.cloudfunctions.net/authors?author=${nftId}`);
            console.log(data);
            setDetails(data);
          } catch (error) {
