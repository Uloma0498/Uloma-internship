  ...
  return (
    <>
      ...
      <div className="col-md-12 text-center">
        <Link onClick={loadMoreItems} to="" id="loadmore" className="btn-main lead" data-aos="fade-zoom-in" data-aos-delay="00" data-aos-easing="ease-in-back" data-aos-offset="0">
          Load more
        </Link>
      </div>
      )}
